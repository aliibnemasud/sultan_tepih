              ...
              <div className="product-card col-lg-3 my-3">
                <div className="card-content rounded">
                  <div className="card-image">
                    <img onClick={this.handleOpenModal} src={product.img[0]} className="img-fluid text-center" alt="" />
                ...
                <div className={`my-modal ${this.state.openModal}`}>
                  <span onClick={this.handleOpenModal} class="close-btn">
                    &times;
                  </span>
